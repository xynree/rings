...
export default class View_Default implements View_DefaultType{ 
  ...
  <div class='w-1/2'>
    <div class="w-3/4 flex flex-col justify-center items-end flex-0">
        <input type='text' class="text-4xl bg-transparent ${this.styles.caret} ${this.styles.selection} mb-4 focus:outline-none ${this.styles.focus} ${this.styles.text1}" id='textdisplaytitle'  required value='My Ring Title'/>
